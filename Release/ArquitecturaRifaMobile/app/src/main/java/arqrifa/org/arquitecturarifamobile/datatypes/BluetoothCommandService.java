...
import arqrifa.org.arquitecturarifamobile.layout.AsistenciaActivity;

//import arqrifa.org.arquitecturarifamobile.layout.MainActivity;
...
public class BluetoothCommandService {
    ...
    private static final UUID MY_UUID = UUID.fromString("00015b38-0000-1000-8000-00805f9b34fb");
...
//    private int mConnectionLostCount;
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(AsistenciaActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
...
//                        .sendToTarget();
        ...
        public void write(String out) {
        	try {
                ...
                mmOutStream.write(END_CMD.getBytes());
