        ...
        <div class="col s12 ">
            <div class="card">
                <div class="card-image blue .card-block" style="height:100px;">
                    <h5 class="card-title">${modelo.verificada? 'Éxito':'Error'}</h5> <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">home</i></a> </div>
