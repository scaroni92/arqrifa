...
public class ControladorReuniones extends Controlador {
    ...
    public void modificar_get() {
        ...
        try {
            cargarVMReunionMantenimiento(vm, cliente.buscarReunion(Integer.parseInt(request.getParameter("id"))));
        } catch (Exception e) {
            vm.setMensaje(e.getMessage());
        }
    ...
    private void cargarVMReunionMantenimiento(VMReunionMantenimiento vm, DTReunion reunion) throws Exception {
